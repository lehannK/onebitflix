...
module.exports = {
  async up(queryInterface, Sequelize) {
    // aqui passamos a chave estrageira que serão os IDs das categorias cadastradas
    // desestruturamos a tabela categories, e dela puxamos os ids, que são passados para cada curso abaixo
